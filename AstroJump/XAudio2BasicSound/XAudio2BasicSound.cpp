...
//--------------------------------------------------------------------------------------
	HRESULT XAudio2BasicSound::PlayPCM(IXAudio2* pXaudio2, LPCWSTR szFilename)
{
    HRESULT hr = S_OK;
...
//--------------------------------------------------------------------------------------
	HRESULT XAudio2BasicSound::FindMediaFileCch(WCHAR* strDestPath, int cchDest, LPCWSTR strFilename)
{
    bool bFound = false;
