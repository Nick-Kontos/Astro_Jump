...
void Physics::update(Game *game)
{
	...
	getAllBotCollsionsForSprite(gsm->getSpriteManager(), gsm->getSpriteManager()->getPlayer(), 1.0f);
...
void Physics::getAllBotCollsionsForSprite(	SpriteManager *spriteManager,
											CollidableObject *sprite,
											float percentageOfFrameRemaining)
{
	spriteManager->findSpriteCollisionsForSprite(this, sprite);
}
